...
def _load_module():
    ...
    mod_path = repo_root / "bin" / "annotate_pairs_methylation.py"
    spec = importlib.util.spec_from_file_location("annotate_pairs_methylation", mod_path)
...
class TestAnnotatePairsMethylation(unittest.TestCase):
    ...
    def test_methyl_string_minus_fragment_softclip_requires_cigar_reverse(self):
        ...
        # soft-clip. In pairtools-style pairs, the seq/cigar are already
